...
export default function Profile() {
    ...
    function saveUniversity(){
        ...
        user.get("univirsity").set(university);
    }
        ...
        <div className="p-16 bg-gray-900">
            <div className="p-8 bg-white shadow mt-24">
                ...
                <div className="mt-20 text-center border-b pb-6">
                    <h1 className="text-4xl font-medium text-gray-700">Riley Cook <span className="font-light text-gray-500">27</span></h1>
                    <p className="font-light text-gray-600 mt-3">Michigan State University</p>
